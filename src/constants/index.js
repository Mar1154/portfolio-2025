...
export const PROJECTS = [
    {
        ...
        description: 'Developed AI-Konsulta, an AI-powered clinic management system using GPT-4o to streamline assessments and clinic workflows.',
    ...
    },
    {
        ...
        description: 'Built a responsive landing page with admin tools for table reservations, event management, and internal organization, aimed at improving their online presence and operational workflow.',
